...
const AddCategory = () => {
  ...
  const handleCategory = (e) => {
    ...
    axios
      .post("http://10.10.1.205:3333/post_category", {
  ...
  const sendCategory = (e) => {
    ...
    axios.put(`http://10.10.1.205:3333/update_category/id`, {
  ...
  const deleteCategory = (id) => {
    axios
      .post(`http://10.10.1.205:3333/update_category/${id}`)
              ...
              <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <tbody>
                  <tr className="bg-white border-b dark:bg-black dark:border-gray-700">
                    ...
                    <td className="px-6 py-4">
                      <button className="font-medium hover:text-danger  text-blue-600 dark:text-blue-500  flex items-center">
                        <Pencil
                          strokeWidth="1"
                          width="18px"
                          className="ms-2 hover:text-danger"
